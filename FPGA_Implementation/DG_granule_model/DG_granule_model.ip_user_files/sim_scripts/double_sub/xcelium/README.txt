...
#
# Generated by export_simulation on Wed Oct 04 16:29:29 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './double_sub.sh' script.

./double_sub.sh -reset_run
...
./double_sub.sh -noclean_files

For more information on the script, please type './double_sub.sh -help'.
