...
HD_PWD='D:/ADAM_LAB/IZ_Neuron_FPGA/FPGA_Implementation/DG_granule_model/DG_granule_model.runs/clk_400_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_400.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_400.tcl
