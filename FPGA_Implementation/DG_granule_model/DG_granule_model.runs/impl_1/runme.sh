...
HD_PWD='D:/ADAM_LAB/IZ_Neuron_FPGA/FPGA_Implementation/DG_granule_model/DG_granule_model.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DG_multiple_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DG_multiple_led.tcl -notrace
