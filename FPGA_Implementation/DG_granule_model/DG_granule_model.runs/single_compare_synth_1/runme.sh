...
HD_PWD='D:/DG_granule_model/DG_granule_model.runs/single_compare_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_compare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_compare.tcl
