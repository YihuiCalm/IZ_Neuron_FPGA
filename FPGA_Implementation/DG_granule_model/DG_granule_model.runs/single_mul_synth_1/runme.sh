...
HD_PWD='D:/DG_granule_model/DG_granule_model.runs/single_mul_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_mul.tcl
