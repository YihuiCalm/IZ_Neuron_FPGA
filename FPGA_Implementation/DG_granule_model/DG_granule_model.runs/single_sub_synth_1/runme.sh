...
HD_PWD='D:/DG_granule_model/DG_granule_model.runs/single_sub_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_sub.tcl
