...
REM
REM Generated by Vivado on Thu Oct 05 19:16:58 -0400 2023
...
echo "xvlog --incr --relax -prj led_spikes_tb_vlog.prj"
call xvlog  --incr --relax -prj led_spikes_tb_vlog.prj -log xvlog.log
