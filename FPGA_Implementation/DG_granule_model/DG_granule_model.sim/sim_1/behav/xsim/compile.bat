...
REM
REM Generated by Vivado on Tue Sep 26 15:52:56 -0400 2023
...
echo "xvlog --incr --relax -prj DG_granule_model_tb_vlog.prj"
call xvlog  --incr --relax -prj DG_granule_model_tb_vlog.prj -log xvlog.log
