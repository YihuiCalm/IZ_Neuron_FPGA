...
HD_PWD='D:/ADAM_LAB/IZ_Neuron_FPGA/FPGA_Implementation/IZ_model_16/IZ_model_16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IZ_pipeline_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IZ_pipeline_16.tcl -notrace
