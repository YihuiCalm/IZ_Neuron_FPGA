...
HD_PWD='D:/ADAM_LAB/IZ_Neuron_FPGA/FPGA_Implementation/IZ_model_16/IZ_model_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IZ_pipeline_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IZ_pipeline_16.tcl
